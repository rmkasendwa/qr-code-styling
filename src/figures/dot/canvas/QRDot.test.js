...
describe('Test QRDot class', () => {
  ...
  it('Should draw simple square dot', () => {
    ...
    const imgFile = fs.readFileSync(
      path.resolve(__dirname, '../../../assets/test/simple_square_dot.png'),
      'base64'
    );
  ...
  it('Should draw simple dots', () => {
    const dotSize = 40;
    const imgFile = fs.readFileSync(
      path.resolve(__dirname, '../../../assets/test/simple_dots.png'),
      'base64'
    );
  ...
  it('Should draw rounded dots', () => {
    ...
    const imgFile = fs.readFileSync(
      path.resolve(__dirname, '../../../assets/test/rounded_dots.png'),
      'base64'
    );
