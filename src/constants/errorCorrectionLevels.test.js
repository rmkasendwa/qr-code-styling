...
describe('Error Correction Levels', () => {
  ...
  it.each(Object.values(errorCorrectionLevels))(
  ...
  it.each(Object.keys(errorCorrectionLevels))(
    'A key of the object should be the same as a value',
    (key) => {
